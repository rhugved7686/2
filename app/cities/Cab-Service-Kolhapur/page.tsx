            ...
            <div className="pt-16 pb-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto h-full flex flex-col justify-center">
              <div className="text-center mb-8">
                <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
                  Kolhapur Cab Booking
                </h1>
                <p className="text-xl text-white/90 max-w-3xl mx-auto">
                  Looking for Cab In Kolhapur? Book reliable, affordable cab services for OutStation, OneWay, Airport Cab and Round Trip from Kolhapur Maharashtra and Other Cities.
                </p>
              </div>

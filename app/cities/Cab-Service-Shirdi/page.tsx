...
// Main Page Component
export default function ShirdiCabServicePage() {
            ...
            <div className="pt-16 pb-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto h-full flex flex-col justify-center">
              <div className="text-center mb-8">
                ...
                <p className="text-xl text-white/90 max-w-3xl mx-auto">
                  WTL Tourism Pvt. Ltd. – Best Cab Service in Shirdi
                </p>
                <p className="text-lg text-white/80 max-w-3xl mx-auto mt-4">
                  Are you looking for the best cab service in Shirdi? WTL Tourism Pvt. Ltd. (World Trip Link) provides reliable and affordable cab services for travelers visiting the holy town of Shirdi. Whether you need a Pune to Shirdi cab service, Mumbai to Shirdi taxi, or a local cab service in Shirdi, we ensure a smooth, safe, and comfortable journey.
                </p>
              </div>
        ...
        <main className="bg-gray-50">
          ...
          <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto bg-gradient-to-br from-blue-50 via-white to-purple-50">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-gray-900 mb-4 relative inline-block">
                Why Choose WTL Tourism Pvt. Ltd. for Cab Services in Shirdi?
                <div className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-blue-500 to-purple-500"></div>
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Experience the best cab service in Shirdi with our professional and reliable transportation solutions.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-4xl mx-auto">
              <div className="group bg-white rounded-xl shadow-lg p-8 border border-gray-100 hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300">
                ...
                <p className="text-gray-600">Competitive and transparent pricing with no hidden costs.</p>
              </div>
              <div className="group bg-white rounded-xl shadow-lg p-8 border border-gray-100 hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3 group-hover:text-purple-600 transition-colors">Professional Drivers</h3>
                <p className="text-gray-600">Well-trained and courteous drivers with local route expertise.</p>
              </div>
              <div className="group bg-white rounded-xl shadow-lg p-8 border border-gray-100 hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300">
              ...
              <div className="group bg-white rounded-xl shadow-lg p-8 border border-gray-100 hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300">
                ...
                <p className="text-gray-600">Book a cab anytime for Shirdi from Pune, Mumbai, or Nashik.</p>
              </div>
              <div className="group bg-white rounded-xl shadow-lg p-8 border border-gray-100 hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3 group-hover:text-red-600 transition-colors">Hassle-Free Booking</h3>
                <p className="text-gray-600">Easy cab booking via WhatsApp or our website.</p>
              </div>
              <div className="group bg-white rounded-xl shadow-lg p-8 border border-gray-100 hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3 group-hover:text-cyan-600 transition-colors">Safe & Comfortable</h3>
                <p className="text-gray-600">Neat and well-maintained vehicles for a smooth ride.</p>
              </div>
            </div>
          </section>
          ...
          <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto bg-gray-50">
            <h2 className="text-3xl font-bold text-gray-900 text-center mb-8">
              Pune to Shirdi & Mumbai to Shirdi Cab Services
            </h2>
            <p className="text-xl text-gray-600 text-center mb-12 max-w-4xl mx-auto">
              We provide comfortable and safe long-distance travel between Pune, Mumbai, and Shirdi. Our services are reliable, affordable, and ensure a hassle-free journey.
            </p>
              ...
              <table className="w-full bg-white shadow-xl rounded-xl overflow-hidden">
                <thead className="bg-gradient-to-r from-blue-600 to-blue-700 text-white">
                  <tr>
                    ...
                    <th className="py-4 px-6 text-left">Fare (Sedan ₹/km)</th>
                    <th className="py-4 px-6 text-left">Fare (SUV ₹/km)</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-200">
                  <tr className="hover:bg-gray-50 transition-colors">
                    <td className="py-4 px-6 font-medium">Ahmednagar to Pune</td>
                    <td className="py-4 px-6">120 km</td>
                    <td className="py-4 px-6">₹12/km</td>
                    <td className="py-4 px-6">₹15/km</td>
                  </tr>
                  <tr className="hover:bg-gray-50 transition-colors">
                    <td className="py-4 px-6 font-medium">Ahmednagar to Mumbai</td>
                    <td className="py-4 px-6">250 km</td>
                    <td className="py-4 px-6">₹11/km</td>
                    <td className="py-4 px-6">₹14/km</td>
                  </tr>
                  <tr className="hover:bg-gray-50 transition-colors">
                    <td className="py-4 px-6 font-medium">Ahmednagar to Shirdi</td>
                    <td className="py-4 px-6">90 km</td>
                    <td className="py-4 px-6">₹13/km</td>
                    <td className="py-4 px-6">₹16/km</td>
                  </tr>
                  <tr className="hover:bg-gray-50 transition-colors">
                    <td className="py-4 px-6 font-medium">Ahmednagar Local</td>
          ...
          <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto bg-gradient-to-b from-white to-blue-50">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-gray-900 mb-4 relative inline-block">
                Local & Outstation Cab Services in Shirdi
                <div className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-blue-500 to-green-500"></div>
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Explore the holy city and nearby attractions with our reliable cab services
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="group bg-white rounded-xl shadow-lg hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 overflow-hidden">
                <div className="p-6 border border-gray-100 bg-gradient-to-br from-blue-50 to-white">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-3 group-hover:text-blue-600 transition-colors">Shirdi to Trimbakeshwar</h3>
                  <p className="text-gray-600">A famous pilgrimage site known for its ancient Shiva temple.</p>
                </div>
              </div>
              <div className="group bg-white rounded-xl shadow-lg hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 overflow-hidden">
                <div className="p-6 border border-gray-100 bg-gradient-to-br from-purple-50 to-white">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-3 group-hover:text-purple-600 transition-colors">Shirdi to Shani Shingnapur</h3>
                  <p className="text-gray-600">Visit the iconic Shani temple with our dedicated cab service.</p>
                </div>
              </div>
              <div className="group bg-white rounded-xl shadow-lg hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 overflow-hidden">
                <div className="p-6 border border-gray-100 bg-gradient-to-br from-amber-50 to-white">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-3 group-hover:text-amber-600 transition-colors">Shirdi to Ajanta & Ellora</h3>
                  <p className="text-gray-600">Explore Maharashtra's UNESCO heritage sites with ease.</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto bg-gray-50">
            <h2 className="text-3xl font-bold text-gray-900 text-center mb-12">
              FAQs – Cab Services in Shirdi
            </h2>
            <div className="max-w-3xl mx-auto space-y-6">
              <FaqItem 
                question="What is the cost of a Pune to Shirdi cab?" 
                answer="Our Pune to Shirdi cab pricing starts at ₹12/km for sedans and ₹15/km for SUVs." 
              />
              <FaqItem 
                question="Are your cabs available 24/7?" 
                answer="Yes, we offer 24/7 cab services for local and outstation travel." 
              />
              <FaqItem 
                question="Do you provide one-way cabs from Mumbai to Shirdi?" 
                answer="Yes, we provide affordable one-way cabs from Mumbai to Shirdi and vice versa." 
              />
              <FaqItem 
                question="Can I book a cab for local sightseeing in Shirdi?" 
                answer="Yes, we offer full-day local sightseeing taxi services in Shirdi at competitive rates." 
              />
              <FaqItem 
                question="What types of cabs are available for booking?" 
                answer="We have sedans, SUVs, and luxury vehicles to suit all travel needs." 
              />
              <FaqItem 
                question="How can I book a cab with WTL Tourism Pvt. Ltd.?" 
                answer="You can book via WhatsApp, call us at 9112085055 | 9130030054, or visit our website." 
              />
              <FaqItem 
                question="Do you provide airport pickup and drop services?" 
                answer="Yes, we offer airport transfers for Pune, Mumbai, and Nashik." 
              />
              <FaqItem 
                question="What payment methods do you accept?" 
                answer="We accept UPI, cash, net banking, and online payments." 
              />
              <FaqItem 
                question="Can I modify or cancel my cab booking?" 
                answer="Yes, modifications and cancellations are allowed with prior notice. Cancellation charges may apply." 
              />
              <FaqItem 
                question="How do I get the best deal on cab bookings?" 
                answer="For the best rates, book your ride in advance through our website or WhatsApp." 
              />
            </div>
          </section>

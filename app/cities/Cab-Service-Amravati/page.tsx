...
// Main Page Component
export default function AmravatiCabServicePage() {
            ...
            <div className="pt-16 pb-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto h-full flex flex-col justify-center">
              <div className="text-center mb-8">
                <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
                  Amravati Cab Booking
                </h1>
                <p className="text-xl text-white/90 max-w-3xl mx-auto">
                  WTL Tourism Pvt. Ltd. – Reliable Cab Service in Amravati
                </p>
              </div>
        ...
        <main className="bg-gray-50">
                ...
                <div className="text-center mb-8">
                  ...
                  <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-6 md:p-8 shadow-lg">
                    <p className="text-lg md:text-xl text-gray-700 leading-relaxed">
                      Amravati Cab Booking at an affordable fare. At WTL, we provide quality services for cab booking, including Outstation, One-way, Airport Cabs, and Round Trips from Amravati, Maharashtra, and other cities. Book your next cab with WTL and enjoy a discount on your total fare to Amravati.
                    </p>
                  </div>
                </div>
          ...
          <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto bg-gray-50">
            <h2 className="text-3xl font-bold text-gray-900 text-center mb-8">
              Why Choose Worldtriplink for Cab Services in Amravati?
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-4xl mx-auto">
              <div className="group bg-white rounded-xl shadow-lg p-8 border border-gray-100 hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3 group-hover:text-blue-600 transition-colors">Punctual and Timely Service</h3>
                <p className="text-gray-600">We respect your time and ensure all our cab services are punctual, with timely pickups and drops.</p>
              </div>
              <div className="group bg-white rounded-xl shadow-lg p-8 border border-gray-100 hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3 group-hover:text-purple-600 transition-colors">Affordable and Transparent Pricing</h3>
                <p className="text-gray-600">Competitive pricing with clear breakdowns and no hidden charges.</p>
              </div>
              <div className="group bg-white rounded-xl shadow-lg p-8 border border-gray-100 hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300">
                ...
                <p className="text-gray-600">From compact sedans to premium SUVs, we have the perfect vehicle for your needs.</p>
              </div>
              <div className="group bg-white rounded-xl shadow-lg p-8 border border-gray-100 hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3 group-hover:text-amber-600 transition-colors">Experienced and Friendly Drivers</h3>
                <p className="text-gray-600">Well-trained, courteous drivers who ensure safe and comfortable rides.</p>
              </div>
            </div>
          </section>

          {/* Pune to Amravati Section */}
          <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto bg-gradient-to-br from-blue-50 via-white to-purple-50">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 relative inline-block">
                  Pune to Amravati Cab Service: Convenient and Comfortable Travel
                  <div className="absolute -bottom-2 left-0 w-full h-1 bg-gradient-to-r from-blue-500 to-purple-500"></div>
                </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="group bg-white rounded-2xl shadow-xl p-8 border border-gray-100 hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-4 group-hover:text-blue-600 transition-colors">Seamless Booking Experience</h3>
                  <p className="text-gray-600">Quick and easy booking through our website or customer support team.</p>
                </div>
                <div className="group bg-white rounded-2xl shadow-xl p-8 border border-gray-100 hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-4 group-hover:text-purple-600 transition-colors">Customizable Travel Packages</h3>
                  <p className="text-gray-600">Explore Amravati with our local city-to-city tour packages.</p>
                </div>
                <div className="group bg-white rounded-2xl shadow-xl p-8 border border-gray-100 hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-4 group-hover:text-green-600 transition-colors">Comfortable and Well-Maintained Cars</h3>
                  <p className="text-gray-600">Air-conditioned vehicles with comfortable seating and ample luggage space.</p>
                </div>
                <div className="group bg-white rounded-2xl shadow-xl p-8 border border-gray-100 hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-4 group-hover:text-amber-600 transition-colors">24/7 Availability</h3>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full bg-white rounded-lg shadow-lg">
                ...
                <tbody className="divide-y divide-gray-200">
                  <tr>
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Pune to Amravati</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">770 km</td>
                  ...
                  <tr>
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Pune to Amravati</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">270 km</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">SUV(Luxury)</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">8500</td>
                  </tr>
                  <tr>
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Amravati to Pune</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">270 km</td>
            ...
            <div className="max-w-3xl mx-auto">
              <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
                <p className="text-lg text-gray-600">
                  Worldtriplink (WTL) was founded in 2016 in Pune with the vision of offering reliable, affordable, and high-quality transportation services across India. We specialize in outstation cab services, employee transportation, daily pick-up & drop services, and hotel & flight bookings.
                </p>
                <p className="text-lg text-gray-600 mt-4">
                  Our fleet consists of over 30 personal cabs, and we have 500+ registered cabs operating across India. We currently manage 100+ city holds and provide services to over 50+ corporate offices. At WTL, we are committed to providing you with the best cab services in Amravati, whether you're traveling for business or leisure.
                </p>
                <p className="text-lg text-gray-600 mt-4">
                  With our experience, professionalism, and customer-first approach, we strive to make every trip with us a memorable one. Let Worldtriplink be your trusted travel companion for all your Pune to Amravati cab services and Amravati to Pune cab services.
                </p>
              </div>
          ...
          <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto bg-gray-50">
            ...
            <div className="max-w-3xl mx-auto space-y-6">
              <FaqItem
                question="What services does Worldtriplink (WTL) provide?"
                answer="WTL offers outstation cab services, employee transportation, daily pick-up & drop services, as well as hotel and flight bookings across India."
              />
              <FaqItem
                question="How many cabs are available in your fleet?"
                answer="We have a fleet of over 30 personal cabs and 500+ registered cabs operating across India."
              />
              <FaqItem
                question="How can I book a cab?"
                answer="You can book a cab through our website, mobile app, or by calling our customer support."
              />
              <FaqItem
                question="Do you provide cab services for corporate offices?"
                answer="Yes, we provide transportation services to over 50+ corporate offices across India."
              />
              <FaqItem
                question="Are your cabs available for outstation trips?"
                answer="Yes, we specialize in outstation cab services, including Pune to Amravati and Amravati to Pune routes."
              />
            </div>
          </section>
            ...
            <div className="max-w-7xl mx-auto relative">
              <div className="text-center mb-12">
                ...
                <p className="text-xl text-white/90 mb-12 max-w-3xl mx-auto">
                  Experience the best cab service in Amravati with our professional and reliable transportation solutions.
                </p>
              </div>
